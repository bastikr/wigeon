...
std::vector<IntersectionTypes<Line2D, Line2D>> intersections2(const Line2D& line0, const Line2D& line1) {
...
std::vector<IntersectionTypes<Ray2D, Line2D>> intersections2(const Ray2D& ray, const Line2D& line) {
...
std::vector<IntersectionTypes<Line2D, Ray2D>> intersections2(const Line2D& line, const Ray2D& ray) {
  std::vector<IntersectionTypes<Ray2D, Line2D>> results = intersections2(ray, line);
...
std::vector<IntersectionTypes<Ray2D, Ray2D>> intersections2(const Ray2D& ray0, const Ray2D& ray1) {
...
std::vector<IntersectionTypes<LineSegment2D, Line2D>> intersections2(const LineSegment2D& segment, const Line2D& line) {
...
std::vector<IntersectionTypes<Line2D, LineSegment2D>> intersections2(const Line2D& line, const LineSegment2D& ray) {
  std::vector<IntersectionTypes<LineSegment2D, Line2D>> results = intersections2(ray, line);
...
std::vector<IntersectionTypes<LineSegment2D, Ray2D>> intersections2(const LineSegment2D& segment, const Ray2D& ray) {
...
std::vector<IntersectionTypes<Ray2D, LineSegment2D>> intersections2(const Ray2D& ray, const LineSegment2D& segment) {
  std::vector<IntersectionTypes<LineSegment2D, Ray2D>> results = intersections2(segment, ray);
...
std::vector<IntersectionTypes<LineSegment2D, LineSegment2D>> intersections2(const LineSegment2D& segment0, const LineSegment2D& segment1) {
...
std::vector<IntersectionTypes<Line2D, Polygon2D>> intersections2(const Line2D& line, const Polygon2D& polygon) {
  ...
  for (size_t i=0; i<polygon.size(); ++i) {
    subresults = intersections2(line, polygon.edge(i));
...
std::vector<IntersectionTypes<Polygon2D, Line2D>> intersections2(const Polygon2D& polygon, const Line2D& line) {
  std::vector<IntersectionTypes<Line2D, Polygon2D>> results = intersections2(line, polygon);
...
std::vector<IntersectionTypes<Ray2D, Polygon2D>> intersections2(const Ray2D& ray, const Polygon2D& polygon) {
  ...
  for (size_t i=0; i<polygon.size(); ++i) {
    subresults = intersections2(ray, polygon.edge(i));
    for (const auto& result: subresults) {
      visitor.index = i;
      results.push_back(result.apply_visitor(visitor));
    }
...
std::vector<IntersectionTypes<Polygon2D, Ray2D>> intersections2(const Polygon2D& polygon, const Ray2D& ray) {
  std::vector<IntersectionTypes<Ray2D, Polygon2D>> results = intersections2(ray, polygon);
...
std::vector<IntersectionTypes<LineSegment2D, Polygon2D>> intersections2(const LineSegment2D& segment, const Polygon2D& polygon) {
  ...
  for (size_t i=0; i<polygon.size(); ++i) {
    subresults = intersections2(segment, polygon.edge(i));
    for (const auto& result: subresults) {
      visitor.index = i;
      results.push_back(result.apply_visitor(visitor));
    }
...
std::vector<IntersectionTypes<Polygon2D, LineSegment2D>> intersections2(const Polygon2D& polygon, const LineSegment2D& segment) {
  std::vector<IntersectionTypes<LineSegment2D, Polygon2D>> results = intersections2(segment, polygon);
...
std::vector<IntersectionTypes<Polygon2D, Polygon2D>> intersections2(const Polygon2D& polygon0, const Polygon2D& polygon1) {
  ...
  for (size_t i=0; i<polygon1.size(); ++i) {
    subresults = intersections2(polygon0, polygon1.edge(i));
    for (const auto& result: subresults) {
      visitor.index = i;
      results.push_back(result.apply_visitor(visitor));
    }
