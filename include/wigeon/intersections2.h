...
std::vector<IntersectionTypes<Line2D, Line2D>> intersections2(const Line2D&, const Line2D&);
...
std::vector<IntersectionTypes<Ray2D, Ray2D>> intersections2(const Ray2D&, const Ray2D&);
std::vector<IntersectionTypes<Ray2D, Line2D>> intersections2(const Ray2D&, const Line2D&);
std::vector<IntersectionTypes<Line2D, Ray2D>> intersections2(const Line2D&, const Ray2D&);
...
std::vector<IntersectionTypes<LineSegment2D, LineSegment2D>> intersections2(const LineSegment2D&, const LineSegment2D&);
std::vector<IntersectionTypes<LineSegment2D, Line2D>> intersections2(const LineSegment2D&, const Line2D&);
std::vector<IntersectionTypes<Line2D, LineSegment2D>> intersections2(const Line2D&, const LineSegment2D&);
std::vector<IntersectionTypes<LineSegment2D, Ray2D>> intersections2(const LineSegment2D&, const Ray2D&);
std::vector<IntersectionTypes<Ray2D, LineSegment2D>> intersections2(const Ray2D&, const LineSegment2D&);
...
std::vector<IntersectionTypes<Polygon2D, Polygon2D>> intersections2(const Polygon2D&, const Polygon2D&);
std::vector<IntersectionTypes<Polygon2D, Line2D>> intersections2(const Polygon2D&, const Line2D&);
std::vector<IntersectionTypes<Line2D, Polygon2D>> intersections2(const Line2D&, const Polygon2D&);
std::vector<IntersectionTypes<Polygon2D, Ray2D>> intersections2(const Polygon2D&, const Ray2D&);
std::vector<IntersectionTypes<Ray2D, Polygon2D>> intersections2(const Ray2D&, const Polygon2D&);
std::vector<IntersectionTypes<Polygon2D, LineSegment2D>> intersections2(const Polygon2D&, const LineSegment2D&);
std::vector<IntersectionTypes<LineSegment2D, Polygon2D>> intersections2(const LineSegment2D&, const Polygon2D&);
